 ...
 */
public abstract class Hilt_MarketFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MarketFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MarketFragment_GeneratedInjector) this.generatedComponent()).injectMarketFragment(UnsafeCasts.<MarketFragment>unsafeCast(this));
    }
  }
